        ...
        <div className="flex justify-center text-center my-6">
          <div className="wrapper grid grid-cols-4 gap-4 items-center">
            <div className="icon facebook relative flex flex-col items-center">
              {/* Facebook */}
              <div className="tooltip absolute">Facebook</div>
              <span>
                <a
            ...
            {/* Instagram */}
            <div className="icon instagram relative flex flex-col items-center">
              <div className="tooltip absolute">Instagram</div>
              <a
            ...
            {/* Linkedin */}
            <div className="icon linkedin relative flex flex-col items-center">
              <div className="tooltip absolute">Linkedin</div>
              <a
            ...
            {/* Github */}
            <div className="icon github relative flex flex-col items-center">
              <div className="tooltip absolute">Github</div>
              <a
